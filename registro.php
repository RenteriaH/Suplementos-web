...
<div id="contact" class="contact">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <form id="registerForm" class="main_form" action="procesar_registro.php" method="POST">
                    <div class="row">
                        <div class="col-md-12">
                            <h3>Regístrate</h3>
                        </div>
                        ...
                        <div class="col-md-12">
                            <input class="contactusmess" placeholder="Número de Teléfono:" type="tel" name="telefono" required>
                        </div>

                        <!-- Contenedor para los mensajes de error -->
                        <div id="mensajes" class="error-messages"></div>
 ...
 <!-- Javascript files-->
<script src="procesar_registros.js"></script>
