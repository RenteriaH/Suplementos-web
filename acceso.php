...
$esInvitado = $estaLogueado && $_SESSION['usuario'] === 'Invitado';
?>

<script>
// Verifica si el usuario está logueado basándote en las variables de sesión de PHP
var estaLogueado = <?php echo json_encode($estaLogueado); ?>;
var esInvitado = <?php echo json_encode($esInvitado); ?>;
</script>
...
<div id="contact" class="contact">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <form id="loginForm" class="main_form" action="procesar_login.php" method="POST">
                    <div class="row">
                        <div class="col-md-12">
                            <h3>Inicia sesión</h3>
                        </div>
                        <div class="col-md-12">
                            <input class="contactus" placeholder="Usuario:" type="text" name="usuario" required>
                        </div>
                        <div class="col-md-12">
                            <input class="contactus" placeholder="Contraseña:" type="password" name="contraseña" required>
                        </div>
                        <div class="col-md-12">
                            <button class="send_btn" type="submit">Iniciar sesión</button>
                        </div>
                        <div class="col-md-12">
                            <button class="send_btn">
                                <a href="registro.php" style="color: white; text-decoration: none;">Registrar</a>
                            </button>
                        </div>
                        <div class="col-md-12">
                            <button class="send_btn">
                            <a href="ingresar_invitado.php" style="color: white; text-decoration: none;">Ingresar como invitado</a>
                            </button>
</div>
                    </div>
                </form>
